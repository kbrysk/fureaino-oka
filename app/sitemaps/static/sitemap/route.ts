...
const STATIC_PAGES: { path: string; priority: number; changeFrequency: SitemapEntry["changeFrequency"] }[] = [
  ...
  { path: "/akiya", priority: 0.9, changeFrequency: "weekly" },
  { path: "/akiya/kaitai-hojokin", priority: 0.85, changeFrequency: "monthly" },
  ...
  { path: "/data/shukatsu-kanshin-map-2026", priority: 0.8, changeFrequency: "monthly" },
  ...
  { path: "/data/seizen-seiri-trends/cluster/core", priority: 0.6, changeFrequency: "monthly" },
  { path: "/data/seizen-seiri-trends/cluster/parent_struggle", priority: 0.6, changeFrequency: "monthly" },
  { path: "/data/seizen-seiri-trends/cluster/parent_child_gap", priority: 0.6, changeFrequency: "monthly" },
  { path: "/data/seizen-seiri-trends/cluster/money_law", priority: 0.6, changeFrequency: "monthly" },
  { path: "/data/seizen-seiri-trends/cluster/disposal", priority: 0.6, changeFrequency: "monthly" },
  { path: "/data/seizen-seiri-trends/cluster/trouble", priority: 0.6, changeFrequency: "monthly" },
