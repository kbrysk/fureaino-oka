...
export const SENRYU_ITEMS: SenryuItem[] = [
  { id: "a1", phrase: "片付けの　手止まるアルバム　若き父", text: "片付けの　手止まるアルバム　若き父", categoryId: "aijo", initialVotes: { empathy: 12, zabuton: 5 }, solutionLink: { text: "写真・アルバムの整理のコツ", url: "/articles/master-guide" } },
  { id: "a2", phrase: "柱の傷　消せずに撫でる　引越し日", text: "柱の傷　消せずに撫でる　引越し日", categoryId: "aijo", initialVotes: { empathy: 8, zabuton: 3 } },
  { id: "b1", phrase: "着物など　要らぬと言うが　売るなと言う", text: "着物など　要らぬと言うが　売るなと言う", categoryId: "family", initialVotes: { empathy: 25, zabuton: 10 }, solutionLink: { text: "着物・古着の処分と買取", url: "/articles/master-guide" } },
  { id: "b2", phrase: "母さんの　『あれは大事』は　ゴミばかり", text: "母さんの　『あれは大事』は　ゴミばかり", categoryId: "family", initialVotes: { empathy: 20, zabuton: 8 }, solutionLink: { text: "家族で話し合うコツ", url: "/articles/master-guide" } },
  ...
  { id: "d1", phrase: "業者呼び　母が隠した　ボロ下着", text: "業者呼び　母が隠した　ボロ下着", categoryId: "experience", initialVotes: { empathy: 15, zabuton: 7 }, solutionLink: { text: "遺品整理の進め方", url: "/articles/master-guide" } },
  ...
  { id: "d3", phrase: "『まだ使う』　十年しまいの　ストーブよ", text: "『まだ使う』　十年しまいの　ストーブよ", categoryId: "experience", initialVotes: { empathy: 22, zabuton: 9 }, solutionLink: { text: "家具・家電の処分", url: "/cost" } },
  { id: "d4", phrase: "段ボール　開けたら中身　また段ボール", text: "段ボール　開けたら中身　また段ボール", categoryId: "experience", initialVotes: { empathy: 28, zabuton: 15 }, solutionLink: { text: "不用品の片付け手順", url: "/articles/master-guide" } },
