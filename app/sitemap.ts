  ...
  if (id === "main") {
    try {
      const staticEntries: MetadataRoute.Sitemap = [
        ...
        { url: `${base}/data/akiya-hojokin-shimekiri-2026`, lastModified, changeFrequency: "monthly", priority: 0.8 },
        { url: `${base}/data/akiya-subsidy-map-2026`, lastModified, changeFrequency: "monthly", priority: 0.85 },
        { url: `${base}/data/shukatsu-kanshin-map-2026`, lastModified, changeFrequency: "monthly", priority: 0.8 },
