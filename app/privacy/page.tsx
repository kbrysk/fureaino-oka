    ...
    <div className="max-w-3xl mx-auto py-8">
      ...
      <article className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-sm">
        ...
        <section>
          ...
          <p>
            本サービスでは、お客様により便利にご利用いただくため、クッキー（Cookie）およびこれに類する技術を利用しています。これにより、お客様のブラウザを識別し、次回以降の入力の手間を省いたり、お客様のご興味に合わせた情報表示が可能になります。広告の配信およびアクセス解析におけるCookieの利用については、第5条・第6条で定めるとおりです。
          </p>
        </section>

        <section>
          <h2 className="text-lg font-bold mt-6 mb-2">第5条（広告の配信およびアフィリエイトプログラムについて）</h2>
          <p>
            当サイトは、Googleを含む第三者配信の広告サービス、および各種アフィリエイトプログラムに参加・利用しています。これらの広告配信事業者は、ユーザーの興味・関心に応じた商品やサービスの広告を表示するため、当サイトや他サイトへの過去のアクセス情報である「Cookie（クッキー）」（氏名、住所、メールアドレス、電話番号などの個人を特定する情報は含まれません）を使用することがあります。
          </p>
          <p>
            Googleなどの第三者配信事業者がCookieを使用することにより、ユーザーのアクセス情報に基づいて適切な広告（パーソナライズ広告）が配信されます。ユーザーは、Googleアカウントの「<a href="https://myadcenter.google.com/" target="_blank" rel="noopener noreferrer" className="text-primary underline">広告設定</a>」から、パーソナライズ広告を無効にすることが可能です。また、「<a href="https://www.aboutads.info/" target="_blank" rel="noopener noreferrer" className="text-primary underline">www.aboutads.info</a>」にアクセスすることで、パーソナライズ広告に使用される第三者配信事業者のCookieを無効にすることができます。
          </p>
          <p>
            当サイトは、Amazon.co.jpをはじめとする第三者が提供するアフィリエイトプログラムの参加者となる場合があります。これにより、当サイトは適格販売により紹介料を獲得できる手段を提供することを目的に設定されたプログラムを利用して収益を得ることがあります。
          </p>
        </section>

        <section>
          <h2 className="text-lg font-bold mt-6 mb-2">第6条（アクセス解析ツールについて）</h2>
          <p>
            当サイトでは、サービスの品質向上および利用状況の分析のため、Googleによるアクセス解析ツール「Googleアナリティクス」をはじめとする解析ツールを利用しています。これらのツールはトラフィックデータの収集のためにCookieを使用しています。このデータは匿名で収集されており、個人を特定するものではありません。
          </p>
          <p>
            ユーザーは、お使いのブラウザの設定でCookieを無効にすることにより、このデータ収集を拒否することが可能です。詳細については、「Google アナリティクス利用規約」および「Googleのサービスを使用するサイトやアプリから収集した情報のGoogleによる使用」に関するポリシーをご確認ください。
          </p>
        </section>

        <section>
          <h2 className="text-lg font-bold mt-6 mb-2">第7条（安全管理措置）</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold mt-6 mb-2">第8条（プライバシーポリシーの改定）</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold mt-6 mb-2">第9条（お問い合わせ窓口）</h2>
          <p>
